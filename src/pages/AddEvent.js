...
function AddEvent({ onEventAdded }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <input required type="text" name="idServiceAdmin" value={eventData.idServiceAdmin} onChange={handleChange} placeholder="ID Service Admin" />
            <input required  type="text" name="idCalendrier" value={eventData.idCalendrier} onChange={handleChange} placeholder="ID Calendrier" />
            ...
            <input required  type="date" name="dateDebut" value={eventData.dateDebut} onChange={handleChange} placeholder="Date de Début" />
