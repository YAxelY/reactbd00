...
const Header = () => {
    ...
    const [notifications, setNotifications] = useState([
        { id: 1, title: '', message: 'Cours de SVT le 15/20/2024 à 14:00' },
        { id: 2, title: '', message: 'Évaluation de SVT le 17/20/2024 à 12:00' },
        { id: 3, title: '', message: 'Cours de SVT le 15/20/2024 à 14:00' },
        { id: 5, title: '', message: 'Rassemblement à la cour le 21/06/2024 à 7:20' },
        { id: 4, title: '', message: 'Cours de SVT le 15/20/2024 à 14:00' },
        ...
        { id: 9, title: '', message: 'Affichage des resulatats du premier semestre le 21/06/2024 à 12:00' },
